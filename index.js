...
app.use(cors())
const uri = "mongodb+srv://db_user:admin123123@cluster0.tcpvg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
  ...
  async function run() {
    ...
    //   menu collection get from database
      ...
      app.get('/carts', async(req, res)=>{
        ...
        const result = await cartCollection.find(query).toArray(express)
        res.send(result)
      })
